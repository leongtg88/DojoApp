...
export default function AboutView({ onOpenEnrollment, onNavigateToHome }: AboutViewProps) {
  ...
  return (
    <div className="space-y-0 min-h-screen bg-brand-bg text-[#dee2f0]">
      ...
      <header className="relative w-full h-[60vh] flex flex-col justify-end px-4 md:px-12 pb-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto w-full space-y-4 text-left">
          <button 
            ...
            className="inline-flex items-center gap-1.5 text-xs font-bold text-brand-accent tracking-wider uppercase hover:text-white transition-colors cursor-pointer group"
          >
          ...
          <h1 className="font-display text-4xl sm:text-6xl font-extrabold tracking-tight text-white leading-none capitalize">
            Sobre Nosotros
          </h1>

          <p className="text-base sm:text-lg text-white/80 max-w-2xl leading-relaxed font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-12 opacity-80">
            <div className="text-center">
              <h5 className="font-bold text-white font-display text-sm tracking-wide">SOKE YOSHIMI INOUE</h5>
              <p className="text-[10px] text-white/50">Fundador de Inoue Ha Japón</p>
            </div>
            <div className="text-white/20 select-none">/</div>
            <div className="text-center">
              <h5 className="font-bold text-white font-display text-sm tracking-wide">SHIHAN MUNEO KANO</h5>
              <p className="text-[10px] text-white/50">Maestro Guía Internacional</p>
            </div>
            <div className="text-white/20 select-none">/</div>
            <div className="text-center">
              <h5 className="font-bold text-white font-display text-sm tracking-wide">KYOSHI JULIO MARTÍNEZ</h5>
              <p className="text-[10px] text-white/50">8vo Dan - Asesor Técnico</p>
            </div>
            <div className="text-white/20 select-none">/</div>
            <div className="text-center">
              <h5 className="font-bold text-white font-display text-sm tracking-wide">SENSEI LEÓN</h5>
              <p className="text-[10px] text-white/50">Director Técnico Dojo</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative h-96 w-full rounded-2xl overflow-hidden shadow-2xl border border-white/10">
            ...
            <div className="absolute bottom-6 left-6 text-left">
              <span className="text-xs bg-brand-red text-white py-1 px-2.5 rounded font-bold font-display uppercase tracking-widest">TRADICIÓN</span>
              <h4 className="font-bold text-lg font-display text-white mt-2">Dedicación Continua</h4>
              <p className="text-xs text-white/70">Formando campeones con humildad.</p>
            </div>
          </div>

          {/* History Text block */}
          <div className="lg:col-span-7 space-y-6 text-left">
            <h3 className="text-3xl sm:text-5xl font-extrabold font-display uppercase text-white leading-tight">
              Nuestra Historia
            </h3>
            <p className="text-sm sm:text-base text-white/70 leading-relaxed font-sans">
      ...
      <section className="py-20 bg-black text-white border-y border-white/5 relative overflow-hidden">
        {/* Glow accent */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="text-center max-w-4xl mx-auto space-y-4">
            ...
            <p className="text-sm sm:text-lg text-white/70 italic leading-relaxed max-w-3xl mx-auto font-sans">
          ...
          <div className="relative rounded-2xl overflow-hidden h-[500px] w-full border border-white/10 shadow-2xl">
            ...
            <div className="absolute inset-x-4 bottom-4 sm:bottom-auto sm:top-1/2 sm:-translate-y-1/2 sm:left-8 sm:max-w-md p-6 bg-brand-card backdrop-blur-xl border border-white/10 rounded-2xl space-y-4 shadow-2xl text-left">
              <div>
                ...
                <h4 className="font-extrabold text-2xl font-display text-white mt-1 uppercase">{senseiLeon.name}</h4>
                <p className="text-xs text-white/60">Cinturón Negro 4to Dan - Inoue Ha Brach</p>
              </div>
              ...
              {senseiLeon.curriculum && (
                <div className="space-y-1.5 pt-2 border-t border-white/10">
                  ...
                  {senseiLeon.curriculum.map((c, i) => (
                    <div key={i} className="flex gap-2 text-[11px] text-white/70">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative h-[500px] w-full rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-brand-card">
            ...
            <div className="absolute bottom-6 left-6 block bg-black/60 px-4 py-2 border border-brand-red rounded backdrop-blur-md">
              ...
              <p className="text-[10px] text-white/60">Cinto Negro 8vo Dan - Inoue Ha Keishin Kai</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className={`glass-card p-6 rounded-2xl border border-brand-accent/20 relative overflow-hidden belt-glow-red bg-black/40`}>
              ...
              <h4 className="font-extrabold text-lg text-white font-display uppercase tracking-wide border-b border-white/10 pb-3 mb-4 flex items-center justify-between">
              ...
              <ul className="space-y-3">
                {kyoshiJulio.curriculum?.map((c, i) => (
                  <li key={i} className="flex items-start gap-3">
                    ...
                    <span className="text-xs sm:text-sm text-white/80 leading-relaxed">{c}</span>
                  </li>
                ))}
              </ul>
            </div>
      ...
      <section className="py-16 bg-[#101725] border-t border-white/5 relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
          ...
          <div className="inline-block bg-black px-8 py-4.5 rounded-2xl border border-white/10 shadow-xl relative">
            ...
            <p className="text-[10px] text-white/60 tracking-wider font-semibold uppercase mt-0.5">Asesor Honorario de la Organización</p>
          </div>
          ...
          <div className="max-w-2xl mx-auto space-y-3">
            <p className="text-xs sm:text-sm text-white/70 leading-relaxed font-sans font-medium italic">
              "{shihanMuneo.bio}"
            </p>
      ...
      <section className="py-16 bg-brand-bg border-t border-white/10 relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
          ...
          <div className="inline-block bg-black px-8 py-4.5 rounded-2xl border border-white/10 shadow-xl">
            ...
            <p className="text-[10px] text-white/60 tracking-wider font-semibold uppercase mt-0.5">Cimiento de la Tecnicidad Nacional</p>
          </div>
      ...
      <section className="py-20 bg-[#101725] text-center border-t border-white/5">
        <div className="max-w-4xl mx-auto px-4 space-y-6">
          ...
          <div className="pt-4 flex flex-col sm:flex-row justify-center gap-4">
            ...
            <button
              onClick={onNavigateToHome}
              className="bg-white/5 hover:bg-white/10 text-white font-semibold px-8 py-4 rounded-xl text-xs border border-white/10 transition-colors uppercase font-display cursor-pointer"
            >
