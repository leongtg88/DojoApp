...
export default function HomeView({ onOpenEnrollment, onNavigateToAbout }: HomeViewProps) {
  ...
  return (
    <div className="space-y-0 min-h-screen bg-brand-bg text-[#dee2f0]">
      ...
      {/* 3. Karate para la Familia (Sección Promocional) */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <h3 className="text-3xl sm:text-5xl font-extrabold font-display text-white leading-tight">
              ...
              <div className="p-4 bg-brand-card/70 ring-1 ring-white/10 rounded-xl space-y-2">
                ...
                <p className="text-xs text-white/60">
                  Inscribe a dos miembros de la familia y obtén un <span className="text-white font-bold">15% de descuento mensual</span> en la mensualidad del tercero. Queremos que el camino del cinturón negro sea un recorrido conjunto.
                </p>
              </div>
              ...
              <div className="pt-2">
                <button
                  ...
                  className="bg-brand-accent hover:bg-brand-accent-hover text-white font-bold px-8 py-3.5 rounded-xl text-sm transition-all text-center flex items-center gap-2 cursor-pointer active:scale-95"
                >
            ...
            <div className="lg:col-span-5 relative h-80 sm:h-96 w-full rounded-2xl overflow-hidden shadow-2xl border border-white/10">
              ...
              <div className="absolute bottom-4 left-4 right-4 text-left">
                ...
                <p className="text-xs text-white/70">Unidos en el sendero del Bushido.</p>
              </div>
            </div>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-4">
          {MOCK_INSTRUCTORS.slice(0, 3).map((inst) => (
            <div 
              key={inst.id} 
              className={`glass-card rounded-2xl overflow-hidden border border-white/5 flex flex-col relative group h-full ${
                inst.id === 'sensei-leon' ? 'ring-1 ring-brand-accent/50 group-hover:ring-brand-accent' : ''
              }`}
            >
              {/* Image banner frame */}
              ...
              <div className="p-6 space-y-4 text-left flex-1 flex flex-col justify-between">
                <div className="space-y-2">
                  <h4 className="font-extrabold text-2xl text-white font-display uppercase tracking-tight group-hover:text-brand-accent transition-colors">
                    {inst.name}
                  </h4>
        ...
        <div className="text-center pt-4">
          <button 
            onClick={onNavigateToAbout}
            className="px-6 py-3.5 bg-brand-card hover:bg-white/5 text-white font-bold rounded-xl text-sm border border-white/15 transition-all inline-flex items-center gap-2 cursor-pointer"
          >
      ...
      {/* 5. Horarios del Dojo */}
      <section className="py-20 bg-[#101725] border-y border-white/5">
            ...
            {DOJO_CLASSES.map((cls, idx) => (
              <div 
                ...
                className={`glass-card p-6 md:p-8 rounded-2xl border ${
                  idx === 0 ? 'border-brand-accent/10' : 'border-brand-secondary/10'
              ...
              >
                <div className="space-y-2 text-left">
                  <div className="flex items-center justify-between">
                    <span className={`text-xs font-bold uppercase tracking-wider px-2.5 py-1 rounded ${
                      idx === 0 ? 'bg-brand-accent/10 text-brand-accent' : 'bg-brand-secondary/10 text-brand-secondary'
                    }`}>
                      {cls.age}
                    </span>
                  ...
                  {cls.schedule.map((sch, sIdx) => (
                    ...
                    >
                      <div className="text-left space-y-0.5">
                        <p className="text-sm font-bold text-white">{sch.days}</p>
                        <p className="text-xs text-white/60">Días establecidos</p>
                      </div>
                ...
                <div className="pt-6">
                  <button
                    ...
                    className="w-full bg-white/5 hover:bg-white/10 text-white font-semibold py-3 rounded-xl text-xs border border-white/10 tracking-wider font-display uppercase cursor-pointer"
                  >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-5 space-y-6 text-left">
            ...
            <div className="space-y-4 bg-brand-card border border-white/5 p-5 rounded-2xl">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-bold text-sm text-white">Dirección de la Escuela</h4>
                  <p className="text-xs text-white/70 mt-0.5">Av. 27 de Febrero #204, Sector Bella Vista, Santo Domingo.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-bold text-sm text-white">Llama Directamente / WhatsApp</h4>
                  <p className="text-xs text-white/70 mt-0.5">+1 (809) 555-0192</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-bold text-sm text-white">Horario de Secretaría</h4>
                  <p className="text-xs text-white/70 mt-0.5">Lunes a Viernes: 2:30 PM - 8:30 PM</p>
                  <p className="text-[10px] text-white/50">Sábados: 8:30 AM - 1:00 PM</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-2">
              <a 
                ...
                className="w-full sm:w-auto bg-brand-accent hover:bg-brand-accent-hover text-white font-bold px-6 py-4 rounded-xl text-xs transition-all tracking-wider font-display uppercase inline-flex items-center justify-center gap-2 cursor-pointer shadow-lg"
              >
                ¿CÓMO LLEGAR AL DOJO?
          ...
          <div className="lg:col-span-7 h-96 w-full rounded-2xl overflow-hidden relative border border-white/10 group bg-[#18181b] flex items-center justify-center">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="relative z-10 glass-card px-6 py-4 rounded-full flex items-center gap-3 text-white border-white/20 font-bold shadow-2xl hover:bg-brand-accent hover:text-black transition-all group-hover:scale-105 cursor-pointer"
            >
      ...
      <section className="py-20 bg-[#101725]/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="text-center space-y-3">
            ...
            <h2 className="text-3xl sm:text-5xl font-extrabold font-display uppercase tracking-tight text-white animate-pulse">
              Testimonios Reales
            </h2>
            <p className="text-sm sm:text-base text-white/60 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
            {MOCK_TESTIMONIALS.map((test) => (
              ...
              >
                {/* Visual quotes sign */}
                <span className="absolute top-6 right-6 font-serif text-white/5 text-8xl pointer-events-none select-none">“</span>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm sm:text-base text-white/80 italic leading-relaxed font-sans">
                    "{test.quote}"
                  </p>
                </div>
      ...
      <section className="py-12 bg-[#050505] border-y border-white/10 font-display overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 text-center space-y-2 mb-6">
          <p className="text-[10px] font-bold text-white/50 tracking-widest uppercase">RECONOCIMIENTO Y CERTIFICACIONES OFICIALES</p>
        </div>
        
        {/* Infinite scrolling marquee of logos/text */}
        <div className="w-full overflow-hidden relative">
          <div className="flex whitespace-nowrap animate-marquee gap-10 text-white/40 text-xs md:text-sm font-bold uppercase tracking-widest py-2">
      ...
      <section className="py-20 bg-[#0d0d0d] border-t border-white/5">
        <div className="max-w-4xl mx-auto px-4 space-y-12 text-left">
          ...
          <div className="text-center space-y-3">
            ...
            <h2 className="text-3xl sm:text-5xl font-extrabold text-center font-display uppercase tracking-tight text-white">
              Preguntas Frecuentes
            </h2>
            <p className="text-sm sm:text-base text-white/60 max-w-2xl mx-auto text-center">
            ...
            {MOCK_FAQS.map((faq) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span className="font-bold text-base sm:text-lg font-display text-white pr-4">
                      {faq.question}
                    </span>
                  ...
                  {isOpen && (
                    <div className="p-5 md:p-6 text-sm text-white/70 bg-black/10 border-t border-white/5 leading-relaxed font-sans">
                      {faq.answer}
                    </div>
                  )}
                </div>
      ...
      <section className="relative py-24 px-4 text-center overflow-hidden bg-brand-bg">
        ...
        <div className="relative z-10 max-w-3xl mx-auto space-y-6">
          ...
          <h2 className="text-4xl sm:text-6xl font-extrabold font-display uppercase tracking-tight text-white leading-tight">
          ...
          <div className="pt-4">
            <button
              onClick={() => onOpenEnrollment('adult')}
              className="w-full sm:w-auto bg-brand-accent hover:bg-brand-accent-hover text-white font-extrabold px-10 py-5 rounded-xl text-base transition-all belt-glow tracking-wider font-display uppercase cursor-pointer"
            >
