          ...
          <div className="max-w-3xl mx-auto z-10 relative">
            ...
            <div className="text-center mb-8">
              <h1
                ref={titleRef}
                tabIndex={-1}
                className="text-3xl md:text-4xl font-bold text-white mb-2 outline-none focus-visible:ring-2 focus-visible:ring-brand-accent rounded-md"
              >
                ...
                <div className="flex items-center justify-between mt-4">
                  {['Datos Personales', 'Compromiso', 'Políticas'].map((label, index) => (
                    <div key={index} className="flex items-center">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${step > index + 1 ? 'bg-green-500 text-white' :
                        step === index + 1 ? 'bg-brand-accent text-white' : 'bg-stone-600 text-stone-300'
                        }`}>
                        {step > index + 1 ? '✓' : index + 1}
                      </div>
                      <span className={`ml-2 text-sm hidden sm:inline ${step === index + 1 ? 'text-white' : 'text-stone-400'
                        }`}>{label}</span>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent outline-none transition ${errors.nombreAlumno ? 'border-red-500' : 'border-stone-300'
                          }`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent outline-none transition ${errors.fechaNacimiento ? 'border-red-500' : 'border-stone-300'
                          }`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent outline-none transition ${errors.email ? 'border-red-500' : 'border-stone-300'
                          }`}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        <div key={name} className={`p-4 border rounded-lg transition ${formData[name as keyof FormData] ? 'border-green-300 bg-green-50' :
