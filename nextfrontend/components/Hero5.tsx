      ...
      >
        ...
        <div className="px-6 flex justify-center max-h-[1300px] items-center sm:px-6 sm:mt-[20px] sm:mb-[20px] md:px-6 md:mt-[20px] md:mb-[20px] xl:grow-1 xl:flex xl:justify-start text-left text-gray-700">
          ...
          >
            ...
            <div className="mt-8 md:ml-4 py-2 px-6 inline-block bg-current backdrop-blur-sm shadow-xl/30 border border-current hover:bg-white hover:border-white hover:text-gray-700 font-regular rounded-lg transition-colors duration-300"
              style={{ animation: "color-change 10s infinite linear" }}>
              <button
                type="button"
                onClick={onOpenAssistant}
                className="text-gray-700 text-sm font-semibold 2xl:text-base cursor-pointer"
              >
                Empieza Hoy
              </button>
            </div>
