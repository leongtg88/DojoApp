...
import { Award, Check, Copy, Loader2, Mail, Pencil, Plus, Search, Trash2, UserCheck, UserMinus, Users, X } from 'lucide-react'
...
function InvitationLinkModal({ open, name, email, url, onClose }: InvitationLinkModalProps) {
