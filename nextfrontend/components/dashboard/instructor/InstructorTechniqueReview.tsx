...
function ExamRubricModal({ onClose, technique }: { onClose: () => void; technique: StudentTechnique | null }) {
    ...
    return (
        <div aria-modal="true" className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 p-4 backdrop-blur-sm" onClick={onClose} role="dialog">
            <div className="max-h-[85vh] w-full max-w-lg overflow-y-auto rounded-xl border border-edge bg-surface-2 p-6 shadow-2xl" onClick={(event) => event.stopPropagation()}>
                <div className="flex items-start justify-between gap-3 border-b border-edge pb-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-base font-bold text-ink">Pautas de Examen Oficial</h3>
                ...
                <div className="mt-3 flex flex-col gap-2.5">
                    {([
                        ...
                        <div className="flex items-start gap-3 rounded-lg border border-transparent p-2.5 transition-colors hover:border-edge hover:bg-surface-4" key={title}>
                            <CheckCheck aria-hidden="true" className="mt-0.5 size-4 shrink-0 text-accent" />
                            <div>
