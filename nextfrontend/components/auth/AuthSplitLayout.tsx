...
export function AuthSplitLayout({ children, mode }: AuthSplitLayoutProps) {
  ...
  return (
    ...
    >
      {/* Container card */}
      <div className="w-full max-w-6xl h-dvh md:h-[min(760px,calc(100dvh-2rem))] bg-[#0f0f0f] md:rounded-3xl shadow-[0_25px_60px_-15px_rgba(0,0,0,0.9)] overflow-hidden border-0 md:border md:border-white/10 flex flex-col md:flex-row relative">
