...
export const YOUTH_RANKS: CurriculumRank[] = [
  ...
  { id: 'belt-youth-04-amarillo-naranja', order: 4, name: 'Naraja-Blanca', kyuDan: '9TH KYU HO', japaneseName: 'Kyu-kyu-ho', kanji: '九級補', beltColor: '#FFE082', minMonths: 9, maxMonths: 10, isMaximumRank: false, katas: ['Tenno Kata', 'Chino Kata', 'Pinan Nidan'] },
  ...
  { id: 'belt-youth-12-verde-cafe', order: 12, name: 'Verde-Blanca', kyuDan: '5TH KYU HO', japaneseName: 'Go-kyu-ho', kanji: '五級補', beltColor: '#A5D6A7', minMonths: 33, maxMonths: 34, isMaximumRank: false, katas: ['Bassai Dai', 'Jūtte', 'Jion', 'Seienchin'] },
